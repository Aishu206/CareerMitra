...
import="com.deepak.connection.DbConnection"%> <%@page
  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div
          class="col-md-6"
          style="background-color: #f9f8f9; margin-top: 10px"
        >
          <jsp:scriptlet>
            if(email == null ? email == null : email.trim().equals("null")) {
          </jsp:scriptlet>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1000.611528507549!2d76.70699078730385!3d30.712056204048775!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x616dfc7292ce7034!2sSmart%20Programming!5e0!3m2!1sen!2sin!4v1608027138020!5m2!1sen!2sin"
            width="100%"
            height="300"
            frameborder="0"
            style="border: 0"
